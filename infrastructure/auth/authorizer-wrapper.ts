...
import { IdentityPoolWrappwer } from './identity-pool-wrapper';
...
export class AuthorizerWrapper {
    ...
    private identityPoolWrappwer: IdentityPoolWrappwer
    ...
    constructor(scope: Construct, api: RestApi) {
        ...
        this.initializeIdentityPoolWrappwer()
    ...
    private initializeIdentityPoolWrappwer() {
        this.identityPoolWrappwer = new IdentityPoolWrappwer(this.scope, this.userPool, this.userPoolClient)
    }
    ...
    private createAdminGroup() {
        new CfnUserPoolGroup(this.scope, 'admins', {
            ...
            roleArn: this.identityPoolWrappwer.adminRole.roleArn
        })
    }
}